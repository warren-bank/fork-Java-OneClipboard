...
set INSTALLER_ZIP_DIR=%INSTALLER_ZIP_BASE_DIR%\OneClipboardDesktopClient
...
set ONE_CLIPBOARD_DESKTOP_CLIENT_OPTS="-Duser.home=%PORTABLE_DATA_DIR%"

rem :: -------------------------------------------
rem :: run
rem :: -------------------------------------------

call "%INSTALLER_ZIP_DIR%\bin\OneClipboardDesktopClient.bat"
