...
set INSTALLER_ZIP_DIR=%INSTALLER_ZIP_BASE_DIR%\OneClipboardDesktopServer
...
set ONE_CLIPBOARD_DESKTOP_SERVER_OPTS="-Duser.home=%PORTABLE_DATA_DIR%"

rem :: -------------------------------------------
rem :: run
rem :: -------------------------------------------

call "%INSTALLER_ZIP_DIR%\bin\OneClipboardDesktopServer.bat"
