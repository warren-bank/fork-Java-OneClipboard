...
call gradlew.bat :OneClipboardAndroidServer:compileReleaseJavaWithJavac
call gradlew.bat :OneClipboardAndroidServer:assembleRelease
...
set APK_DIR=OneClipboardAndroidServer\build\outputs\apk\release
set APK_SRC=%APK_DIR%\OneClipboardAndroidServer-release-unsigned.apk
set APK_DST=%APK_DIR%\OneClipboardAndroidServer-release.apk
